"""Utility functions for infrastructure healthchecks."""
...
def check_api_health() -> bool:
    """
    Verifica la conectividad con la API de CoinGecko.
...
def check_db_health(engine: Engine) -> bool:
    """
    Verifica la conectividad con PostgreSQL mediante una consulta.
    ...
    try:
        ...
        logger.error(
            f"Healthcheck Failure: Database connection failed. Error -> {e}"
        )
        return False
